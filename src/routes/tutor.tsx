...
import { BadgeCheck, Loader2, Lock, Send, Sparkles } from "lucide-react";
    ...
    return (
      <AppShell title="AI Tutor">
        <div className="surface mt-6 p-6 text-center">
          ...
          <p className="mt-2 text-sm font-bold">AI tutor is part of Max Pro</p>
          <p className="mt-1 text-xs text-muted-foreground">
            Max Pro also gives you the blue tick on the leaderboard and ad-free study.
          </p>
          <Link
            to="/subscribe"
          ...
          >
            <BadgeCheck className="h-4 w-4" /> Upgrade to Max Pro
          </Link>
        </div>
      </AppShell>
    );
